...
Check out the website : https://the-paradise-web.vercel.app
1. Next js (for front end and backend logic)
2. supa base a database
3. Tailwind css for styling
4. Google auth as auth provider for safe and smooth authentication
...
You can review the website by clicking on the link above 👆
